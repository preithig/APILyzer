...
public enum RuleEnum {
  ...
  MISSING_REQUEST_BODY_EXAMPLE("MISSING_REQUEST_BODY_EXAMPLE", "Example is missing for the request body", "Example is missing for the request body", "To fix this issue, plese add an example as per the provided schema"),
